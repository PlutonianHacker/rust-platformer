...
fn set_movement_actions(mut actions: ResMut<Actions>, keyboard_input: Res<Input<KeyCode>>) {
    ...
    if GameControl::Enter.just_released(&keyboard_input)
        || GameControl::Enter.pressed(&keyboard_input)
    {}
}
...
impl GameControl {
    fn just_released(&self, keyboard_input: &Res<Input<KeyCode>>) -> bool {
        match self {
            ...
            GameControl::Enter => keyboard_input.just_released(KeyCode::Return),
        }
    }
    ...
    fn pressed(&self, keyboard_input: &Res<Input<KeyCode>>) -> bool {
        match self {
            ...
            GameControl::Enter => keyboard_input.pressed(KeyCode::Return),
        }
    }
